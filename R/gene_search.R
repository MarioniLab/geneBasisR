...
.add_first_gene = function(sce , stat_all, batch = NULL , n.neigh = 5, p.minkowski = 3 , K = 5){
  first_genes = lapply(1:K , function(dump){
    gene = .add_gene_to_current_selection(sce , stat_all, genes = NULL , batch = batch , n.neigh = n.neigh, nPC = NULL, p.minkowski = p.minkowski)
  })
